...
import 'package:trades_website/screens/main_screens/convert/convert_design/convert_design.dart';
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              const TopHeaderDesign(
                ...
                selectedScreenTwoIndex: 4,
              ),

              Padding(
                padding: const EdgeInsets.only(top: 48, right: 80, left: 80,bottom: 110),
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Container(
